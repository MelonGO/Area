...
public class Movable {
    ...
    //构造器
    public Movable(int x, int y, int r, Bitmap bitmap, int num) {
        ...
        switch (num){
            case 0:
                ...
                break;
            case 1:
                this.v_x = 20 + (int) ((StartView.V_MAX - StartView.V_MIN) * Math.random());
                break;
            case 2:
                this.v_x = 35 + (int) ((StartView.V_MAX - StartView.V_MIN) * Math.random());
                break;
            case 3:
                this.v_x = 50 + (int) ((StartView.V_MAX - StartView.V_MIN) * Math.random());
                break;
        }
